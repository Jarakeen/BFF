...
# UESP's page title for the Rockgrove boss.
...
def main() -> None:
    ...
    assert first.name == "Flame-Herald Bahsei"
    assert first.source is not None
    assert first.source.page_title == page.title
    assert first == second, "Bahsei parsing is not deterministic"
    ...
    print("BAHSEI PARSE TEST PASSED")
