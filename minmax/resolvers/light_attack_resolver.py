...
def resolve_light_attack_state(
    *,
    ...
    return LightAttackState(
        ...
        la_physical_spell_damage=la_physical_spell_damage,
        la_physical_weapon_damage=la_physical_weapon_damage,
        ...
        physical_damage_done=physical_damage_done,
        bow_damage_done=bow_damage_done,
        skill_line_damage_bow=skill_line_damage_bow,
