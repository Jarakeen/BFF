...
"""Read-only repository for Phase 6 damage-linked secondary healing."""

import sqlite3
from pathlib import Path

from .skill_component_secondary_healing import (
...
class SkillComponentSecondaryHealingRepository:
    ...
    def resolve(
        ...
        return extract_explicit_secondary_healing(
