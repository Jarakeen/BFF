...
"""Read-only repository for Phase 6 resource-restore display semantics."""
...
class SkillComponentResourceRestoreDisplayRepository:
    ...
    def resolve(
        ...
        return extract_explicit_component_resource_restore_display(
