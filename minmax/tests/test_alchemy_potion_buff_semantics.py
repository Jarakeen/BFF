...
def test_u50_standard_potion_traits_route_to_named_buffs():
    ...
    assert potion_buff_for_trait("Increase Armor") == "Major Resolve"
    assert potion_buff_for_trait("Increase Spell Resist") == "Major Resolve"
...
def test_u51_consolidated_traits_route_to_surviving_named_buffs():
    assert potion_buff_for_trait("Increase Armor", game_update=GameUpdate.U51) == "Major Resolve"
    assert potion_buff_for_trait("Increase Spell Resist", game_update=GameUpdate.U51) == "Major Resolve"
