...
"""Read-only repository for canonical Phase 6 component roles."""

import re
import sqlite3
from pathlib import Path

from .skill_component_role import SkillComponentRole, extract_explicit_component_roles
...
class SkillComponentRoleRepository:
    ...
    def resolve(
        ...
        if not evidence.fragment or evidence.effect_kind not in {"damage", "heal"}:
            return ()

        return extract_explicit_component_roles(
