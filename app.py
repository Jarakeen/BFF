...
def main() -> int:
    ...
    install_build_screenshot_import_support()
    ...
    # Urban Wilderness Raid Map stack presets reuse the existing themed marker
    # renderer without creating another toolbar row.
    ...
    # Help owns a top-level navigation entry and a searchable guide page.
    install_help_support()
