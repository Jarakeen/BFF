...
REFERENCE_SERVICE_DESCRIPTORS: tuple[ServiceDescriptor, ...] = (
    ...
    ServiceDescriptor(
        ...
        notes="Only reviewed gear-set mappings and versioned Alchemy trait semantics are projected. Passive providers remain unresolved until a shared reviewed passive-provider authority exists.",
    ),
    ServiceDescriptor(
