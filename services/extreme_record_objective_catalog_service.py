...
EXTREME_RECORD_OBJECTIVES: tuple[ExtremeRecordObjective, ...] = (
    ...
    ExtremeRecordObjective("sustained_dps", "MOST Sustained DPS", ExtremeRecordDomain.OFFENSE, ExtremeRecordMeasure.SUSTAINED, "Highest proven single-target modeled DPS over an explicit combat-simulation window, using a legal saved build and deterministic RotationPlan.", runtime_required=True),
