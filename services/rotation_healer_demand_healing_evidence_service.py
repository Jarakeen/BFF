...
class RotationHealerDemandHealingEvidence:
    ...
    received-heal thresholds. Direct modeled healing can therefore be reported
    without pretending it proves survival. Periodic seeds remain unresolved for
    demand coverage until their runtime ticks are scheduled.
    """
