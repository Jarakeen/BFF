...
_REVIEWED_H1_PRECONDITION_TEXT = (
    ...
    re.compile(
        r"Stygian \(5\): active set bonus is not yet mechanic-mapped:.*"
        r"When you leave Sneak or invisibility while in combat, your Weapon and Spell Damage is increased by\s*"
        r"(?:\d[\d,]*\s*-\s*)?369\s*for\s*15 seconds",
        re.IGNORECASE | re.DOTALL,
    ),
    re.compile(
