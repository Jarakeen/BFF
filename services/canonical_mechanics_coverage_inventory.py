    ...
    return (
        ...
        CanonicalMechanicsCoverageEvidence(
            ...
            missing_evidence=(
                ...
                "ExtremePassiveProjectionService now also rejects max-rank passive source "
                "disagreements carried by the canonical skill universe, so stale rank text cannot "
                "be projected merely because an ability tooltip is parseable. It otherwise "
                "classifies simple unconditional passive tooltip contributions and fails "
        ...
        CanonicalMechanicsCoverageEvidence(
            ...
            capability=(
                ...
                "Vulnerability target combat math. Generated Objective #32 search now enumerates the "
                "canonical crafted-poison formula catalog independently on legal front/back bars, then "
                "intersects every selected formula trait over imported Poison solvent/level coordinates "
                "to search a finite source-backed tier denominator. Poison tiers are now a first-class "
                "canonical Objective #32 mutation axis, so theoretical closure cannot treat formula search "
                "alone as complete weapon-poison coverage. Front/back tier choices remain "
                "independent, are retained on the assembled candidate, and runtime consequence authority "
                "selects the tier belonging to the proc source bar. Literal per-trait '(triple)' source "
                "annotations are preserved and mixed per-effect dilution witnesses are supported, while "
                "unmarked or implicit source cells remain provenance rather than guessed base-duration "
                "mechanics. The saved label alone still proves neither formula nor dilution. Imported "
                "formula section headings are preserved as audit provenance but are not promoted to "
                "dilution authority."
            ),
            evidence_source=(
                "minmax/character_build/saved_build_adapter.py; "
                ...
                "services/extreme_sustained_dps_generated_weapon_poison_tier_frontier_service.py; "
                "services/extreme_sustained_dps_generated_weapon_poison_tier_loadout_frontier_service.py; "
                "services/extreme_sustained_dps_generated_weapon_poison_formula_authority_service.py; "
                "services/extreme_sustained_dps_generated_weapon_poison_dilution_authority_service.py; "
                "services/extreme_sustained_dps_generated_weapon_poison_consequence_authority_factory_service.py; "
                ...
                "services/extreme_sustained_dps_weapon_poison_named_effect_authority_service.py; "
            ...
            missing_evidence=(
                ...
                "interrupt legality/timing, remaining enchant cooldown topology, authoritative "
                "per-effect ordinary/triple duration semantics for generated poison formulas when source "
                "cells are unmarked or implicit, remaining poison-trait relationships, Ravage Health/resource "
                "magnitudes and periodic application, dual-wield/two-hand legacy "
