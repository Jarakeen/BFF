...
BUILD_SERVICE_DESCRIPTORS: tuple[ServiceDescriptor, ...] = (
    ...
    ServiceDescriptor(
        ...
        outputs=("CompBuildPersistenceResult", "CanonicalBuildRecord"),
        dependencies=("build.catalog.persistence",),
        responsibilities=("comp_maker_build_promotion", "comp_maker_build_identity_persistence"),
        behavior=ServiceBehavior.DETERMINISTIC,
        ui_safe=True,
        evidence_class=EvidenceClass.NONE,
        notes="Uses the same canonical build model as ordinary saved builds. Real occupied chairs receive build_kind=comp records and stable build IDs; recruit chairs are skipped and existing ordinary saved builds are never overwritten.",
    ),
    ServiceDescriptor(
