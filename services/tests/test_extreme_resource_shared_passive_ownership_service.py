...
_EXPECTED_IDENTITIES = {
    ...
    (ExtremeSkillDomain.ARMOR, "Heavy Armor", "Constitution"),
    (ExtremeSkillDomain.ARMOR, "Heavy Armor", "Rapid Mending"),
    (ExtremeSkillDomain.ARMOR, "Heavy Armor", "Resolve"),
    (ExtremeSkillDomain.ARMOR, "Heavy Armor", "Revitalize"),
    (ExtremeSkillDomain.ARMOR, "Light Armor", "Grace"),
    (ExtremeSkillDomain.ARMOR, "Medium Armor", "Athletics"),
    (ExtremeSkillDomain.ARMOR, "Medium Armor", "Improved Sneak"),
    (ExtremeSkillDomain.ARMOR, "Medium Armor", "Medium Armor Bonuses"),
    ...
    (ExtremeSkillDomain.WEAPON, "Bow", "Hasty Retreat"),
    (ExtremeSkillDomain.WEAPON, "Bow", "Hawk Eye"),
    (ExtremeSkillDomain.WEAPON, "One Hand and Shield", "Deflect Bolts"),
    (ExtremeSkillDomain.WEAPON, "One Hand and Shield", "Fortress"),
    (ExtremeSkillDomain.WEAPON, "Two Handed", "Follow Up"),
    (ExtremeSkillDomain.WEAPON, "Two Handed", "Heavy Weapons"),
