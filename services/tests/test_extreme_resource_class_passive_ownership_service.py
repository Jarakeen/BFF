...
_EXPECTED_IDENTITIES = {
    ...
    ("Herald of the Tome", "Harnessed Quintessence"),
    ("Herald of the Tome", "Psychic Lesion"),
    ("Herald of the Tome", "Splintered Secrets"),
    ("Living Death", "Corpse Consumption"),
    ("Living Death", "Curative Curse"),
    ("Living Death", "Near-Death Experience"),
    ("Living Death", "Undead Confederate"),
    ("Restoring Light", "Light Weaver"),
    ("Restoring Light", "Master Ritualist"),
    ("Restoring Light", "Mending"),
    ("Restoring Light", "Sacred Ground"),
    ("Shadow", "Dark Veil"),
    ("Shadow", "Refreshing Shadows"),
    ("Shadow", "Shadow Barrier"),
    ("Siphoning", "Catalyst"),
    ("Siphoning", "Magicka Flood"),
    ("Siphoning", "Soul Siphoner"),
    ("Siphoning", "Transfer"),
    ("Soldier of Apocrypha", "Aegis of the Unseen"),
    ("Soldier of Apocrypha", "Circumvented Fate"),
    ("Soldier of Apocrypha", "Implacable Outcome"),
    ("Soldier of Apocrypha", "Wellspring of the Abyss"),
    ("Storm Calling", "Amplitude"),
