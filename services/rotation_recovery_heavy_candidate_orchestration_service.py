...
RecoveryRuntimeTargetCombatStateResolver = Callable[[float, int | None], CombatState]
RecoveryRuntimeTargetCombatStateResolverFactory = Callable[
    [RotationPlan],
