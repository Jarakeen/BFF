...
- **Theoretical MOST Sustained DPS closure gate** — separates “the finite generated tree is fully solved” from “Objective #32 is theoretically solved.” The stronger claim requires a proven finite search, complete coverage of every canonical sustained-DPS mutation axis, and zero explicitly omitted theoretical scope; continuous timing, runtime, or encounter-policy omissions therefore remain visible instead of being hidden behind a successful branch-and-bound run.
