...
- **Phase 14 periodic-damage timing safety gate** — prevents whole-plan DoT totals from being applied at cast time inside Combat Simulation. Saved-build skills/Ultimates with reviewed periodic damage remain explicitly unresolved until occurrence-level tick magnitudes are available, while direct damage continues through the canonical DD bridge.
