...
-[ ] Comp Maker: add a class + race coverage optimizer that finds efficient player archetype combinations for maximum unique raid buff/debuff coverage before gear. Report unique effects, duplicated coverage, uncovered effects, and provider provenance; use racial passives as role/efficiency weighting when they do not directly provide group effects, and support best 4/8/12-player spreads without treating raw effect count as more important than strategically weighted raid effects.
