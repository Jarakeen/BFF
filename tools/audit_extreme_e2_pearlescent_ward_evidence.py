...
"""Read-only Pearlescent Ward evidence audit for Extreme E2 H1."""
...
def main() -> int:
    ...
    print("EXTREME E2 PEARLESCENT WARD EVIDENCE AUDIT")
    print(f"database={database}")
    if gear_set is None:
        print("set_found=False")
        return 1

    print("set_found=True")
    ...
    print("NEXT_STEP=use the exact canonical blocker text above to tighten the reviewed H1 matcher; do not broaden admission generically")
    return 0
