...
COMMANDS = (
    (
        ...
        [
            ...
            "services/tests/test_raid_section_state_attempt_history.py",
            ...
            "services/tests/test_comp_maker_template_pydantic_persistence.py",
            "services/tests/test_encounter_position_timeline.py",
            "services/tests/test_roster_workspace_pydantic_persistence.py",
            "services/tests/test_roster_canonical_player_binding_service.py",
            "services/tests/test_roster_canonical_character_binding_service.py",
