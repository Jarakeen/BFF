...
CORE_NAV_SECTIONS = [
    ...
    {"label": "Collectibles", "page": "collectibles", "children": [
        ...
        ("Head Markings", "collectibles:Head Markings"),
        ("Body Markings", "collectibles:Body Markings"),
        ("Facial Accessories", "collectibles:Facial Accessories"),
        ("Facial Hair / Horns", "collectibles:Facial Hair / Horns"),
        ("Piercing / Jewelry", "collectibles:Piercing / Jewelry"),
