...
DASHBOARD_SPECS = (
    ...
    DashboardSpec("Pets", "Pets", ("pet",), "bar", "✦"),
    DashboardSpec("Armor Styles", "Armor Styles", ("armor_style",), "bar", "◆"),
    DashboardSpec("Weapon Styles", "Weapon Styles", ("weapon_style",), "bar", "†"),
    DashboardSpec("Skins", "Skins", ("skin",), "bar", "◉"),
    DashboardSpec("Costumes", "Costumes", ("costume",), "bar", "♜"),
    DashboardSpec("Personalities", "Personalities", ("personality",), "bar", "☽"),
    DashboardSpec("Emotes", "Emotes", ("emote",), "bar", "✧"),
    DashboardSpec("Polymorphs", "Polymorphs", ("polymorph",), "bar", "◌"),
    DashboardSpec("Mementos", "Mementos", ("memento",), "bar", "⌘"),
    DashboardSpec("Furnishings", "Furnishings", ("furnishing",), "bar", "⌂"),
    DashboardSpec("Assistants", "Allies / Assistants", ("assistant",), "bar", "♟"),
    DashboardSpec("Companions", "Allies / Assistants", ("companion",), "bar", "♢"),
    ...
    DashboardSpec("Hats", "Hairstyles & Adornments", ("hat",), "bar", "△"),
    ...
    DashboardSpec("Piercing / Jewelry", "Hairstyles & Adornments", ("piercing_jewelry",), "bar", "◊"),
    DashboardSpec("Houses", "Houses", ("house",), "bar", "⌂"),
    DashboardSpec("Customized Actions", "Customized Actions", ("customized_action",), "bar", "✤"),
    DashboardSpec("Fragments", "Fragments", ("fragment", "combination_fragment", "patron"), "bar", "✥"),
    DashboardSpec("Tools & Upgrades", "Tools & Upgrades", ("tool", "account_upgrade", "story", "skill_style"), "bar", "⚒"),
)
