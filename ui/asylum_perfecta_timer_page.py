...
class AsylumPerfectaTimerPage(FoundryPage):
    ...
    def _build_workspace(self) -> None:
        ...
        deaths_heading = self._muted("DEATHS")
        deaths_heading.setAlignment(Qt.AlignmentFlag.AlignCenter)
        deaths_box.addWidget(deaths_heading)
        self.deaths_label = self._big_label("0", 32)
        deaths_box.addWidget(self.deaths_label, 0, Qt.AlignmentFlag.AlignHCenter)
        run_row.addLayout(deaths_box, 1)

        status_box = QVBoxLayout()
        status_box.setSpacing(0)
        status_heading = self._muted("STATUS")
        status_heading.setAlignment(Qt.AlignmentFlag.AlignCenter)
        status_box.addWidget(status_heading)
        self.run_status = self._big_label("READY", 18)
        status_box.addWidget(self.run_status, 0, Qt.AlignmentFlag.AlignHCenter)
