...
"""Expose the proof-closed U50 Magicka Recovery record in Extreme Build Lab."""
...
_INSTALLED = False
_OBJECTIVE = ExtremeMagickaRecoveryRecordService.OBJECTIVE_KEY
...
def install() -> None:
    ...
    def build_ui_with_record(self) -> None:
        ...
        card = FoundryCard("Proven Magicka Recovery Record")
        card.setObjectName("extremeMagickaRecoveryRecordCard")
        ...
        self.magicka_recovery_record_card = card
