...
def test_lower_open_coverage_uses_exact_raid_plan_handoff() -> None:
    ...
    assert "def _open_coverage(self, *_args) -> None:" in coverage_page
    assert "self._request_plan_coverage()" in coverage_page
